...
class Welcome(commands.Cog):
    ...
    async def on_member_join(self, member: discord.Member):
        ...
        if channel is not None:
            ...
            embed.set_image(
                url='https://media.discordapp.net/attachments/902836100261879818/1099532213990735952/ezgif.com-gif-maker_7.gif')
            embed.set_footer(text=f'Thanks to you, we now have {guild.member_count} members!',
                             icon_url='https://media.discordapp.net/attachments/896803697223401522/1087555998434213978/seele_love.png')
